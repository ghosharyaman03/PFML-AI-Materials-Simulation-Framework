...
//   }
   ...
   if ((boundary[0][3].type == 2) || (boundary[1][3].type == 2)) {
     trace_strain_front += avg_strain.xx;
     trace_strain_back  += avg_strain.xx;
     trace_strain_right += avg_strain.xx;
     trace_strain_left  += avg_strain.xx;
   }
   if ((boundary[2][3].type == 2) || (boundary[3][3].type == 2)) {
     trace_strain_front += avg_strain.yy;
     trace_strain_back  += avg_strain.yy;
     trace_strain_right += avg_strain.yy;
     trace_strain_left  += avg_strain.yy;
   }
...
//   printf("mu_prime_right=%le, mu_prime_left=%le\n", mu_prime_right, mu_prime_left);
  ...
  if ((boundary[0][3].type == 2) || (boundary[1][3].type == 2)) {
    sigma_xx_front += 2.0*mu_front*avg_strain.xx	+ mu_prime_front*avg_strain.xx;
    sigma_xx_back  += 2.0*mu_back*avg_strain.xx	  + mu_prime_back*avg_strain.xx;
  } 
...
// 		              + grad_left->stiffness[Y][2]*grad_left->strain[Y][Y][Y];
  ...
  if ((boundary[2][3].type == 2) || (boundary[3][3].type == 2)) {
    sigma_yy_right  += 2.0*mu_right*avg_strain.yy + mu_prime_right*avg_strain.yy;
    sigma_yy_left   += 2.0*mu_left*avg_strain.yy  + mu_prime_left*avg_strain.yy;
  }
...
//   trace_strain_bottom     = 0.0;
  ...
  trace_strain_bottom    = grad_bottom->strain[Z].xx  + grad_bottom->strain[Z].yy  + grad_bottom->strain[Z].zz;
   ...
   if ((boundary[0][3].type == 2) || (boundary[1][3].type == 2)) {
     ...
     trace_strain_right   += avg_strain.xx;
     trace_strain_left    += avg_strain.xx;
     trace_strain_top     += avg_strain.xx;
     trace_strain_bottom  += avg_strain.xx;
   }
   if ((boundary[2][3].type == 2) || (boundary[3][3].type == 2)) {
     trace_strain_front   += avg_strain.yy;
     trace_strain_back    += avg_strain.yy;
     trace_strain_right   += avg_strain.yy;
     trace_strain_left    += avg_strain.yy;
     trace_strain_top     += avg_strain.yy;
     trace_strain_bottom  += avg_strain.yy;
   }
   if ((boundary[4][3].type == 2) || (boundary[5][3].type == 2)) {
     trace_strain_front   += avg_strain.zz;
     trace_strain_back    += avg_strain.zz;
     trace_strain_right   += avg_strain.zz;
     trace_strain_left    += avg_strain.zz;
     trace_strain_top     += avg_strain.zz;
     trace_strain_bottom  += avg_strain.zz;
   }
  ...
  if ((boundary[0][3].type == 2) || (boundary[1][3].type == 2)) {
    sigma_front.xx += 2.0*mu_front*avg_strain.xx	+ mu_prime_front*avg_strain.xx;
    sigma_back.xx  += 2.0*mu_back*avg_strain.xx	  + mu_prime_back*avg_strain.xx;
  }
  ...
  if ((boundary[2][3].type == 2) || (boundary[3][3].type == 2)) {
    sigma_right.yy  += 2.0*mu_right*avg_strain.yy + mu_prime_right*avg_strain.yy;
    sigma_left.yy   += 2.0*mu_left*avg_strain.yy  + mu_prime_left*avg_strain.yy;
  }
  ...
  if ((boundary[4][3].type == 2) || (boundary[5][3].type == 2)) {
    sigma_top.zz      += 2.0*mu_top*avg_strain.zz     + mu_prime_top*avg_strain.zz;
    sigma_bottom.zz   += 2.0*mu_bottom*avg_strain.zz  + mu_prime_bottom*avg_strain.zz;
  }
