...
void Mu_0(double T, double *y, double *Mu) {
   ...
   : (
      0
   ))/pow(1.0*y[0] + 1.0*y[1], 2)) - ((18821.0 - 8.9525500000000005*T)*y[0] - 702.79999999999995*pow(y[0] - y[1], 3)*y[0] + 2108.3999999999996*pow(y[0] - y[1], 2)*y[0]*y[1])/(1.0*y[0] + 1.0*y[1]) + ((18821.0 - 8.9525500000000005*T)*y[1] - 702.79999999999995*pow(y[0] - y[1], 3)*y[1] - 2108.3999999999996*pow(y[0] - y[1], 2)*y[0]*y[1])/(1.0*y[0] + 1.0*y[1]) + ((T >= 298.0 && T < 6000.0) ? (
      -1.8*T + ((T >= 298.0 && T < 700.0) ? (
         -8.7766400000000004e-7*pow(T, 3) - 0.0018846620000000001*pow(T, 2) - 24.3672*T*log(T) + 137.07149999999999*T - 7976.1499999999996 + 74092/T
      )
      : ((T >= 700.0 && T < 933.60000000000002) ? (
